...
export const Terminal = () => {
  ...
  return (
    <div className="min-h-[480px] min-w-[360px] bg-neutral-800 text-neutral-300 p-2 font-mono tracking-wide" onClick={focusInput}>
      {
      ...
      <div className="flex gap-2">
        ...
        <input
          ref={inputRef}
          type="text" className="bg-transparent text-neutral-300 outline-0 flex-1" onKeyDown={handleKeyDown} />
      </div>
    </div>
  )
}
